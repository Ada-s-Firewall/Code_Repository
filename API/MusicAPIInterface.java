...
public interface MusicAPIInterface {
    ...
    /**
     * Given an ID, return the ArtistObject associated with the ID.
    ...
    /**
     * Given an ID, return the TrackObject associated with the ID.
    ...
    /**
     * Given an AlbumObject, load its tracks.
